...
$items = [
  ...
  [ 'shield', 'Long-Term Durability',    'Properly cared-for implants are designed to last a lifetime. Every DreamSmile<sup class="ds-tm">&trade;</sup> is backed by our Silver, Gold, or Platinum warranty.',                   'Lifetime Warranty available' ],
];
?>
<!-- wp:html -->
