    ...
    <div class="ds-quiz-grid">
      ...
      <aside class="ds-quiz-book ds-reveal">
        <div class="ds-quiz-book__chip">
          <svg viewBox="0 0 24 24" width="11" height="11" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v14"/><path d="M5 10l7 7 7-7"/><path d="M5 21h14"/></svg>
          <span>FREE DOWNLOAD &middot; 64 PAGES</span>
        </div>
        ...
        <div class="ds-quiz-book__media">
          <img src="<?php echo esc_url( $book ); ?>" alt="The Complete Handbook on Dental Implants &mdash; DreamSmile" loading="lazy" />
        ...
        <div class="ds-quiz-card ds-reveal" data-ds-quiz>
          ...
          <div class="ds-quiz-card__next-wrap">
            <span class="ds-quiz-card__trust">
              <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="4" y="10" width="16" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/></svg>
      ...
      <aside class="ds-guide-card ds-reveal">
        ...
        <ul class="ds-guide-card__trust" aria-label="Guide delivery assurance">
          <li>
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2l3 7h7l-5.5 4 2 7L12 16l-6.5 4 2-7L2 9h7z"/></svg>
