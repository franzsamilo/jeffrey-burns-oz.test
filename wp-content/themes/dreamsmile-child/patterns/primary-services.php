  ...
  <div class="ds-wrap">
    ...
    <div class="ds-services__grid">
      <div class="ds-service-card ds-reveal">
        ...
        <a href="#quiz" class="ds-btn ds-btn--solid ds-btn--sm">GET YOUR DREAMSMILE</a>
      </div>
      ...
      <div class="ds-service-card ds-reveal">
        ...
        <a href="#quiz" class="ds-btn ds-btn--solid ds-btn--sm">CHOOSE YOUR SERVICE</a>
      </div>
      ...
      <div class="ds-service-card ds-reveal">
        ...
        <a href="#quiz" class="ds-btn ds-btn--solid ds-btn--sm">LEARN MORE</a>
      </div>
    </div>
  </div>
</section>
